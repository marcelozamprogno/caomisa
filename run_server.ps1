...
while ($listener.IsListening) {
    try {
        ...
        elseif (([System.IO.Path]::GetExtension($localPath) -eq "" -or [System.IO.Path]::GetExtension($localPath).ToLower() -eq ".html") -and ($localPath -eq "/" -or $localPath -eq "/index.html" -or $localPath -eq "/produtos" -or $localPath -eq "/ajuda" -or $localPath -eq "/politicas" -or $localPath -eq "/checkout" -or $localPath.StartsWith("/produto/"))) {
